...
import com.gmx.emoji.goo.AssetFileAddress;
import com.gmx.emoji.goo.BinaryDictionaryGetter;
...
public class DictionaryInfoUtils {
    ...
    public static final String RESOURCE_PACKAGE_NAME = com.gmx.emoji.goo.R.class.getPackage().getName();
