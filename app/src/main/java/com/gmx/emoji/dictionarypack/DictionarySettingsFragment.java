...
package com.gmx.emoji.dictionarypack;
...
public final class DictionarySettingsFragment extends PreferenceFragment
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final View v = inflater.inflate(com.gmx.emoji.goo.R.layout.loading_page, container, true);
        mLoadingView = v.findViewById(com.gmx.emoji.goo.R.id.loading_container);
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.gmx.emoji.goo.R.xml.dictionary_settings);
        refreshInterface();
                ...
                if (!TextUtils.isEmpty(metadataUri)) {
                    if (mUpdateNowMenu == null) {
                        mUpdateNowMenu = menu.add(Menu.NONE, MENU_UPDATE_NOW, 0,
                                        com.gmx.emoji.goo.R.string.check_for_updates_now);
    ...
    private Collection<? extends Preference> createInstalledDictSettingsCollection(
        ...
        final Uri contentUri = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT)
                .authority(getString(com.gmx.emoji.goo.R.string.authority))
                .appendPath(clientId)
        ...
        if (null == cursor) {
            ...
            result.add(createErrorMessage(activity, com.gmx.emoji.goo.R.string.cannot_connect_to_dict_service));
            return result;
        }
        try {
            if (!cursor.moveToFirst()) {
                final ArrayList<Preference> result = new ArrayList<>();
                result.add(createErrorMessage(activity, com.gmx.emoji.goo.R.string.no_dictionaries_available));
                return result;
            }
    ...
    private void startLoadingAnimation() {
        ...
        if (null != mUpdateNowMenu) mUpdateNowMenu.setTitle(com.gmx.emoji.goo.R.string.cancel);
    }
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (null != updateNowMenu) {
                    updateNowMenu.setTitle(com.gmx.emoji.goo.R.string.check_for_updates_now);
                }
            }
        });
    }
