...
package com.gmx.emoji.keyboard.emoji;
...
final class EmojiLayoutParams {
    ...
    public EmojiLayoutParams(final Resources res) {
        ...
        mKeyVerticalGap = (int) res.getFraction(com.gmx.emoji.goo.R.fraction.config_key_vertical_gap_holo,
                defaultKeyboardHeight, defaultKeyboardHeight);
        mBottomPadding = (int) res.getFraction(com.gmx.emoji.goo.R.fraction.config_keyboard_bottom_padding_holo,
                defaultKeyboardHeight, defaultKeyboardHeight);
        mTopPadding = (int) res.getFraction(com.gmx.emoji.goo.R.fraction.config_keyboard_top_padding_holo,
                defaultKeyboardHeight, defaultKeyboardHeight);
        mKeyHorizontalGap = (int) (res.getFraction(com.gmx.emoji.goo.R.fraction.config_key_horizontal_gap_holo,
                defaultKeyboardWidth, defaultKeyboardWidth));
        mEmojiCategoryPageIdViewHeight =
                (int) (res.getDimension(com.gmx.emoji.goo.R.dimen.config_emoji_category_page_id_height));
